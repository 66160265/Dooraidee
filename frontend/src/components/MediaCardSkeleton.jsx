function MediaCardSkeleton() {
    return (
        <div className="flex h-[220px] rounded-2xl overflow-hidden shadow-md bg-gray-100">
            <div className="relative w-[150px] h-full bg-gray-200 shrink-0 overflow-hidden shimmer"></div>
